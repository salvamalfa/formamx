...
- **Vista previa**: /taller muestra la imagen del plato antes de imprimir,
  sacada de dentro del propio 3MF (NO con `--export-png`, que rompe el
  rebanado entero — ver maña 5). Es best effort: sin sesión gráfica el 3MF
  viene sin ella y la pieza se revisa solo con los estimados.
