...
copy config.example.toml C:\Users\salva\Desktop\FORMA\06-Web\config.toml
notepad C:\Users\salva\Desktop\FORMA\06-Web\config.toml
#   → pega agent_token, serial de la impresora, y revisa ip/access_code

# 3. Carpeta de los 3MF rebanados
mkdir C:\Users\salva\Desktop\FORMA\06-Web\3mf\pantalla
mkdir C:\Users\salva\Desktop\FORMA\06-Web\3mf\cuerpo
mkdir C:\Users\salva\Desktop\FORMA\06-Web\3mf\tapa
```
...
```
C:\Users\salva\Desktop\FORMA\06-Web\3mf\pantalla\tessera.petg.gcode.3mf   (y diamond, fluted... según el material)
C:\Users\salva\Desktop\FORMA\06-Web\3mf\cuerpo\cuerpo.pla.gcode.3mf
C:\Users\salva\Desktop\FORMA\06-Web\3mf\tapa\tapa.pla.gcode.3mf
```
...
```powershell
cd C:\Users\salva\Desktop\FORMA\06-Web\formamx\agent
python -m formamx_agent.flatten_profiles `
  "C:\Program Files\Bambu Studio\resources\profiles\BBL" `
  C:\Users\salva\Desktop\FORMA\06-Web\perfiles
```
...
```powershell
cd C:\Users\salva\Desktop\FORMA\06-Web\formamx\agent
python -m formamx_agent C:\Users\salva\Desktop\FORMA\06-Web\config.toml
```
...
schtasks /Create /TN "formamx-agent" /SC ONLOGON /RL LIMITED `
  /TR "'C:\Windows\py.exe' -3 -m formamx_agent C:\Users\salva\Desktop\FORMA\06-Web\config.toml" `
  /IT
```

(o Programador de tareas → Crear tarea básica → Al iniciar sesión → Iniciar un
programa: `py -3 -m formamx_agent C:\Users\salva\Desktop\FORMA\06-Web\config.toml`,
"Iniciar en": `C:\Users\salva\Desktop\FORMA\06-Web\formamx\agent`.)

El log queda en `C:\Users\salva\Desktop\FORMA\06-Web\agent.log`.
